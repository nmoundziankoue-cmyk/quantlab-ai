...
export const useNotificationLogs = (params = {}) =>
  useQuery({ queryKey: ["notification-logs", params], queryFn: () => api.listNotificationLogs(params), refetchInterval: 10000 });

export const useNotificationTemplates = (params = {}) =>
  useQuery({ queryKey: ["notification-templates", params], queryFn: () => api.listTemplates(params) });

export const useNotificationChannels = () =>
  useQuery({ queryKey: ["notification-channels"], queryFn: api.listChannels });
